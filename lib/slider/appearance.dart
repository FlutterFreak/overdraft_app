...
class CircularSliderAppearance {
  static const double _defaultSize = 260;
  static const double _defaultStartAngle = 135.0;
  static const double _defaultAngleRange = 272.0;

  static Color _defaultTrackColor = Colors.grey[300];
  static const Color _defaultInitialProgressColor = Colors.lightBlueAccent;
  ...
  static const double _defaultGradientStartAngle = 10.0;
  static const double _defaultGradientEndAngle = 180.0;
  static const bool _defaultHideShadow = true;
  ...
  double get trackWidth => _customTrackWidth ?? progressBarWidth;
  double get progressBarWidth => _customProgressBarWidth ?? size / 7;
  ...
  Color get _customInitialProgressTrackColor =>
      customColors != null ? customColors.initialProgressBarColor : null;
  ...
  Color get initialProgressBarColors =>
      _customInitialProgressTrackColor ?? _defaultInitialProgressColor;
...
class CustomSliderColors {
  ...
  final Color initialProgressBarColor;
